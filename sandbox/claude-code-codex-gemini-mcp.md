...
![Claude CodeからCodex CLI・Gemini CLIを使えるようにする](https://images.ctfassets.net/ct0aopd36mqt/3KBTm8tdpO9RJJuaVvVzod/a9964bb03097b448b2327edc6920bf9f/Claude.png?w=3840&fm=webp)

> 元記事: [Claude CodeからCodex CLI・Gemini CLIを使えるようにする | DevelopersIO](https://dev.classmethod.jp/articles/claude-code-codex-gemini-mcp/)
>
> 著者: 山本暁斗
>
> 公開日: 2026-02-06
...
![Preview Featuresの設定画面](https://devio2024-2-media.developers.io/upload/6euGKPoI6cFuIYlo9FPIdX/2026-01-21/cAvPh62qdhDy.png)
...
![各AIモデルのレビュー比較結果](https://devio2024-2-media.developers.io/upload/6euGKPoI6cFuIYlo9FPIdX/2026-01-21/ExNUydcrT3uv.png)
...
- [Codex Agents SDK Guide | OpenAI](https://platform.openai.com/docs/guides/codex-agents-sdk)
- [Get Started with Gemini 3 | Gemini CLI](https://github.com/anthropics/claude-code)
...
「オペレーション・エクセレンス」と「らしく働く、らしく生きる」を共に実現するカルチャー・しくみ・働き方にご興味がある方は、[クラスメソッドオペレーションズ株式会社 コーポレートサイト](https://www.classmethod.co.jp/) をぜひご覧ください。※2026年1月 アノテーション株式会社から社名変更しました
